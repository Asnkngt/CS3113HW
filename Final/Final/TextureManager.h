...
extern std::vector<std::pair<GLuint, size_t>> fbos;
...
size_t LoadTexture(const char * filepath, int textureformat, GLint paramMin = GL_NEAREST, GLint paramMag = GL_NEAREST);

size_t GenerateFBO(int width = 1920, int height = 1080);